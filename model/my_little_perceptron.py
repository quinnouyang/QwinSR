...
# Originally written by Ze Liu and Jingyun Liang.
# Modified by Mark Bauer and Quinn Ouyang
# -----------------------------------------------------------------------------------
...
class QwinSR(nn.Module):
    r"""QwinSR
        A PyTorch implementation of : `QwinSR: An All-MLP Shifted Window Model for Image Super Resolution`, based on SwinIR and Swin-Mixer.
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # build Residual Swin MLP blocks (RSMB)
